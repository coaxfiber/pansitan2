            ...
            storage.get('email').then(function (val) {
                ...
                storage.get('image').then(function (val) {
                    ...
                    _this.http.get(_this.global.site + 'api.php?action=getaccount&email=' + _this.email + '&name=' + _this.name + '&image=' + _this.image)
                        ...
                        _this.acct = res;
                        console.log(_this.global.site + 'api.php?action=userpostings&email=' + _this.email + '&limit=' + _this.limit);
...
Options = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */]) === "function" && _c || Object])
], Options);
